...
namespace rdmaio
{
  ...
  namespace qp
  {
    ...
    public:
      ...
      struct ReqDesc
      {
        // `op` could be IBV_WR_RDMA_READ / IBV_WR_RDMA_WRITE /
        // IBV_WR_RDMA_ATOMIC
        ibv_wr_opcode op;
      ...
      static bool bring_dc_to_init(ibv_qp *qp)
      {
        ...
        long flags = IBV_QP_STATE | IBV_QP_PKEY_INDEX | IBV_QP_PORT |
                     IBV_QP_DC_KEY;

        return ibv_modify_qp(qp, &qp_attr, flags) == 0;
      }
      ...
      static bool bring_dc_to_rtr(ibv_qp *qp)
      {
        ...
        long flags = IBV_QP_STATE | IBV_QP_PATH_MTU | IBV_QP_AV;
      ...
      static bool bring_dc_to_rts(ibv_qp *qp)
      {
        ...
        long flags = IBV_QP_STATE | IBV_QP_TIMEOUT | IBV_QP_RETRY_CNT |
